...
public class Paint extends JPanel {
				...
				if (result == JFileChooser.APPROVE_OPTION) {
					try {
						...
						if (jarEntry.getName().endsWith(".class")) {
							...
							System.out.println((Class<? extends Shape>) loa.getClass().forName(classBinName,true, loa)+"hahhahaha");
							 Class<? extends Shape> c1 = (Class<? extends Shape>) loa.getClass().forName(classBinName,true, loa);
				...
				JFileChooser chooser = new JFileChooser();
				 chooser.setDialogTitle("choose save place");
				    ...
				    if (chooser.showOpenDialog(mp) == JFileChooser.APPROVE_OPTION) { 
				    	drawEngine.save(chooser.getCurrentDirectory().toString());
				     }
				    else {
			...
			public void actionPerformed(ActionEvent arg0) {
				JFileChooser chooser = new JFileChooser();
				 chooser.setDialogTitle("choose load place");
				    ...
				    //    
				    if (chooser.showOpenDialog(mp) == JFileChooser.APPROVE_OPTION) { 
				    	drawEngine.load(chooser.getCurrentDirectory().toString());
	...
	public class MyPanel extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			/*
			 * if(select==true) { Shape temp= drawEngine.findSelectedShape(x,
			 * y); if(temp!=null) { if(!selectedShape.contains(temp))
